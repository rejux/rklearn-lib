...
def main(config):
    ...
    try:
        ...
        logger.info("=========================================")
        logger.info("")
        logger.info("No data viz: confer to the perceptron test for data viz examples.")
        ...
        logger.info("")
        logger.info("================================================================")
        logger.info("                Fitting the rklearn AdalineGD")
        logger.info("================================================================")
        logger.info("")
        ...
        logger.info("")
        logger.info("================================================================")
        logger.info("                Fitting the rklearn AdalineSGD")
        logger.info("================================================================")
        logger.info("")
